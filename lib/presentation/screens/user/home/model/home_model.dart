...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        categories: json["categories"] == null
            ? []
            : List<HomeCategoryElement>.from(json["categories"]!
                .map((x) => HomeCategoryElement.fromJson(x))),
        newestPodcasts: json["newestPodcasts"] == null
            ? []
            : List<HomeNewestPodcast>.from(json["newestPodcasts"]!
                .map((x) => HomeNewestPodcast.fromJson(x))),
        popularPodcasts: json["popularPodcasts"] == null
            ? []
            : List<HomeNewestPodcast>.from(json["popularPodcasts"]!
                .map((x) => HomeNewestPodcast.fromJson(x))),
        reels: json["reels"] == null
            ? []
            : List<HomeNewestPodcast>.from(
                json["reels"]!.map((x) => HomeNewestPodcast.fromJson(x))),
        albums: json["albums"] == null
            ? []
            : List<HomeAlbumItem>.from(
                json["albums"]!.map((x) => HomeAlbumItem.fromJson(x))),
        topCreators: json["topCreators"] == null
            ? []
            : List<HomeTopCreator>.from(
                json["topCreators"]!.map((x) => HomeTopCreator.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "newestPodcasts": newestPodcasts == null
            ? []
            : List<dynamic>.from(newestPodcasts!.map((x) => x.toJson())),
        "popularPodcasts": popularPodcasts == null
            ? []
            : List<dynamic>.from(popularPodcasts!.map((x) => x.toJson())),
        "reels": reels == null
            ? []
        ...
        "topCreators": topCreators == null
            ? []
            : List<dynamic>.from(topCreators!.map((x) => x.toJson())),
      };
}
...
class HomeAlbumItem {
  ...
  factory HomeAlbumItem.fromJson(Map<String, dynamic> json) => HomeAlbumItem(
        ...
        podcasts: json["podcasts"] == null
            ? []
            : List<String>.from(json["podcasts"]!.map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "podcasts":
            podcasts == null ? [] : List<dynamic>.from(podcasts!.map((x) => x)),
...
class HomeCategoryElement {
  ...
  factory HomeCategoryElement.fromJson(Map<String, dynamic> json) =>
      HomeCategoryElement(
        id: json["_id"],
        name: json["name"],
...
class HomeNewestPodcast {
  ...
  factory HomeNewestPodcast.fromJson(Map<String, dynamic> json) =>
      HomeNewestPodcast(
        ...
        creator: json["creator"] == null
            ? null
            : HomeCreator.fromJson(json["creator"]),
        category: json["category"] == null
            ? null
            : SubCategoryClass.fromJson(json["category"]),
        subCategory: json["subCategory"] == null
            ? null
            : SubCategoryClass.fromJson(json["subCategory"]),
