...
class PodcastEditController extends GetxController{
  ...
  var selectedCategory = Rxn<String>("Genres Podcast");
  var selectedItem = Rxn<String>("National Baptist Convention of America International");
