...
import 'controller/podcast_edit_controller.dart';

class PodcastEditScreen extends StatefulWidget {
  const PodcastEditScreen({super.key});
...
class _PodcastEditScreenState extends State<PodcastEditScreen> {
  final controller = Get.find<PodcastEditController>();
  @override
        ...
        child: Column(
          children: [
            ...
            CustomTextField(
              ...
              controller: TextEditingController(text: "Promises (feat. Joe L Barnes & Naomi Raine) _ Maverick City Music _ TRIBL"),
            ...
            CustomTextField(
              ...
              controller: TextEditingController(text: "Dhaka, Bangladesh"),
