                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Gap(8.h),
                            CustomText(text: _controller.profile.value.data?.name??"",fontSize: 24,fontWeight: FontWeight.w700,color: isDarkMode?AppColors.blackColor:AppColors.blackColor,),
                            const Gap(2),
                            CustomText(text: _controller.profile.value.data?.email??"",fontSize: 16,fontWeight: FontWeight.w100,color: isDarkMode?AppColors.blackColor:AppColors.blackColor,),
                          ],
                        ),
                      ),
                      Gap(44.h),
